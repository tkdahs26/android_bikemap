# Public Bike Map App (Android)

## 프로젝트 개요

공공 데이터 API를 활용해 공용 자전거 대여소 위치를 지도 위에 표시하는 Android 기반 위치 탐색 애플리케이션입니다.

도시를 선택하면 해당 지역의 자전거 대여소 정보를 조회하고 지도 마커를 통해 위치를 확인할 수 있도록 구현했습니다.
...
### 공공 자전거 대여소 조회
 서울, 광양 등 선택한 지역의 자전거 대여소 위치 표시
 지도 상에 대여소 위치를 마커로 출력

### 위치 기반 정보 제공
 지도 클릭 또는 마커 선택 시 해당 위치 정보 확인
 주변 환경 정보를 확인할 수 있도록 API 연동



## 구현 특징

 공공 데이터 API를 활용한 자전거 대여소 정보 조회
 지도를 통한 위치 정보 시각화
 API 연동을 통해 장소 관련 정보 얻음
