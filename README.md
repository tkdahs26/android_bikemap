...
MarkerOptions api을 활용하여 사용자 지정 마커 아이콘을 생성하고 지도에 배치했습니다.
...
기능: 사용자가 선택한 위치의 실시간 길거리 뷰를 지원.

Street View 화면을 구현하고, 지도에서 얻은 정보를 저장 후, 이를 Street View 카메라 위치로 연동했습니다.

4) 주소 기능 활용
기능: 특정 주소를 변환하거나 지도상의 좌표를 주소로 변환하여 사용자에게 제공.

Geocoder를 활용하여 정확도를 높이고, 사용자에게 친숙한 주소 정보를 제공하는 로직을 구현했습니다.
